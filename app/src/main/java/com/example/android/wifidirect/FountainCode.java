...
public class FountainCode {
    ...
    private static final long DEFAULT_DATALENGTH = 3709L; //input.getBytes("UTF-8").length;
    ...
    public static ArrayDataDecoder getDecoder(int overhead){
        return OpenRQ.newDecoder(getParameters(DEFAULT_DATALENGTH),overhead);
    }
